...
*   **Recommendation:** The Center for Transportation Research (CTR) recommends that TxDOT transition the MRMS-CRIS data workflow from the current NetCDF implementation, as detailed in the [technical documentation](https://github.com/Adam-Kosicki/mrms_cris_records_mapping_TxDOT/blob/tacc_lonestar6/docs/TXDOT_Deliverable_Draft.md) currently under review, to a new pipeline that sources data directly from NOAA in GRIB2 format.
